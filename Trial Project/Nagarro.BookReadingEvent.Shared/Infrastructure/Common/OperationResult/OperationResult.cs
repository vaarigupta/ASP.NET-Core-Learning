...
namespace Nagarro.BookReadingEvent.Shared
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public BookReadingValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, BookReadingValidationResult validationResult)
        {
            this.Data = data;
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(BookReadingValidationResult validationResult)
        {
